...
- (void)applicationDidFinishLaunching:(UIApplication *)application {
	...
	WebViewController *aBrowserViewController;
    aBrowserViewController = [[WebViewController alloc] initWithTabBar];
	localNavigationController = [[UINavigationController alloc] initWithRootViewController:aBrowserViewController];
	[localControllersArray addObject:localNavigationController];
	[localNavigationController release];
	[aBrowserViewController release];
